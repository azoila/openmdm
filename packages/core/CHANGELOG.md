...
- [#48](https://github.com/azoila/openmdm/pull/48) [`72d3cd6`](https://github.com/azoila/openmdm/commit/72d3cd6e515fc2e8e3cafc6c2d4750a4a781622a) Thanks [@andersonkxiass](https://github.com/andersonkxiass)! - Map device-identity enrollment errors to real HTTP statuses instead of 500.
...
- [#43](https://github.com/azoila/openmdm/pull/43) [`5378703`](https://github.com/azoila/openmdm/commit/537870352eb58606c6af581c073ab9245cb1d71b) Thanks [@andersonkxiass](https://github.com/andersonkxiass)! - `devices.beginUnenroll()` can now override or suppress the command it queues (#42).
